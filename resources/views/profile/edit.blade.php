          ...
          <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                @endif
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-current-password">{{ __('Actuel mot de passe') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-password-confirmation">{{ __('Confirmation') }}</label>
                  <div class="col-sm-7">
